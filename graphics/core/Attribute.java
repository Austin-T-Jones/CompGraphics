...
{
    // int, or vec2/vec3/vec4, or float, can be whatever we need
    ...
    /**
     * associate the data stored in the buffer to
     ...
     * @param variableName the name of a variable in the vertex shader
     */
    public void associateVariable(int programRef, String variableName)
    {
        ...
        // re-activate buffer: to ensure the associateVariable runs on the correct buffer
        glBindBuffer( GL_ARRAY_BUFFER, bufferRef);
